...
if(!('flashMassage')){
    ...
    function flashMassage($message, $type='success'): void
    {
...
if(!function_exists('siganaturMidtrans')){
    function siganaturMidtrans($order_id , $status_code, $gross_amount, $server_key) {
